...
class ExamplesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create example" do
    assert_difference('Example.count') do
      post examples_url, params: { example: { contenido: @example.contenido, unit_id: @example.unit_id } }, as: :json
    end
  ...
  test "should update example" do
    patch example_url(@example), params: { example: { contenido: @example.contenido, unit_id: @example.unit_id } }, as: :json
    assert_response 200
  end
